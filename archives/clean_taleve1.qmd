...
```{r}
p1 <- plot(
  ggeffect(modele_complet, terms = "annee", residual = TRUE),
  colors = "Okabe-Ito"
) +
  ggtitle("Prédiction du nombre de Talève par visite")
p1
...
p3 <- plot(
  ggeffect(modele_complet, terms = "nom_lieu", residual =T),
  colors = "Okabe-Ito"
) +
  ggtitle("Abondance des talèves en fonction des sites") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) 
