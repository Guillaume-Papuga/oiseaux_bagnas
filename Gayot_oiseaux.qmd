...
#modele_julian2annee <- glm(nombre_min ~ julian*annee + I(julian^2),
 #                  data = Protocole_SuiviTaleve, 
  #                 family = poisson)
##### Modeles complets 
#modele_julian2_annee <- glm(nombre_min ~ julian + I(julian^2)+annee,
 #                  data = Protocole_SuiviTaleve, 
#                   family = poisson)
#modele_complet_site <- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu,
                        data = Protocole_SuiviTaleve, 
                   family = poisson ) # meilleur AIC avec le model interaction mais le nombre de parametres largement plus faible (12 < 20 ) donc on le prend
#modele_complet_anneesite <- glm(nombre_min~ annee*nom_lieu + julian + I(julian^2),
#                        data = Protocole_SuiviTaleve, 
 #                  family = poisson )
#modele_complet_site <- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu,
#                        data = Protocole_SuiviTaleve, 
...
modele_complet_vent <- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + vent_moyen,
                        data = Protocole_SuiviTaleve, 
                   family = poisson )
#### Modèle temperature

modele_complet_temp_31j <- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + temp_moy_glissante_31j+ vent_moyen,
                        data = Protocole_SuiviTaleve, 
                   family = poisson )

modele_complet_temp_7j <- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + temp_moy_glissante_7j+ vent_moyen,
                        data = Protocole_SuiviTaleve, 
                   family = poisson )

modele_complet_temp_1j<- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + temperature+ vent_moyen,
                        data = Protocole_SuiviTaleve, 
                   family = poisson )

#### Modèle pluie

modele_complet_pluie_31j<- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + pluie_moy_glissante_31j + vent_moyen,
                        data = Protocole_SuiviTaleve, 
                   family = poisson )

modele_complet_pluie_7j<- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + pluie_moy_glissante_7j + vent_moyen,
                        data = Protocole_SuiviTaleve, 
                   family = poisson )
modele_complet_pluie_1j<- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + pluie_1h + vent_moyen,
                        data = Protocole_SuiviTaleve, 
                   family = poisson )

### modele hydro 
modele_complet_assec <- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + vent_moyen + AssecT_1,
                           data = Protocole_SuiviTaleve, 
                           family = poisson )
                           

modele_complet_profondeur <- glm(nombre_min~ annee + julian + I(julian^2)+ nom_lieu + vent_moyen + Profondeur,
                           data = Protocole_SuiviTaleve, 
                           family = poisson )
