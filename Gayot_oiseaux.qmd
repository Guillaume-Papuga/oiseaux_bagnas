...
Protocole_SuiviTaleve$annee <- factor(Protocole_SuiviTaleve$annee)
Protocole_SuiviTaleve$mois  <- factor(Protocole_SuiviTaleve$mois)
Protocole_SuiviTaleve$jour <- factor (Protocole_SuiviTaleve$jour)
...
# Transformer en facteurs
Opportuniste_Taleve$annee <- factor(Opportuniste_Taleve$annee)
Opportuniste_Taleve$mois  <- factor(Opportuniste_Taleve$mois)
Opportuniste_Taleve$jour <- factor (Opportuniste_Taleve$jour)
# Ne pas mettre jour comme facteur si beaucoup de lignes pour éviter le crash
```
