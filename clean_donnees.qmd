...
Pour des raisons écologiques, on utilise les assec de l'année qui précède l'année d'étude. JUSTIFICATION BIBLIO?
On crée une variable Assec de l'année précédente avec 3 modalités : non (pas d'assec), partiel et total.
```{r}
...
Ce graphique représente les observations par observateurs.
