...
Le tableau process_data correspond aux données sur toute la periode 1990-2025 pour toutes les données sur les 3 espèces d'interet. On crée par la suite un tableau qui ne comprend que les données des protocoles, donc à partir de 2014, et pour des sites d'études particuliers.
...
Les données hydro nous interessent pour la profondeur moyenne et les assec

On rajoute ensuite les variables hydro dans le process_protocole et environnement_daily
...
Cartographie des sites d'écoute des 3 espèces confondues. Les sites sur la carte sont les 9 sites du protocole.
