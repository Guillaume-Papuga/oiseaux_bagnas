...
```{r}
##### création des lignes manquantes du tableau environnement_daily

# etape 1 création d'un tableau de 2013 à 2025 avec une variable jour julian
...
# etape 2 on va forcer le rajout des lignes avec un full.join qui permet de rajouter toutes les lignes 
# du tableau 2 au premier tableau meme si les lignes n'ont pas de jointures

environnement_daily <- read_csv("data/pro/environnement_daily.csv")
