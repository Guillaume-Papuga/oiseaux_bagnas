...
glm_blongios_temps <- glm(nombre_min ~ julian_day + I(julian_day^2), family = binomial, data = Protocole_SuiviBlongios)
...
glm_blongios_temps_hydro <- glm(nombre_min ~ julian_day + I(julian_day^2) + ProfondeurMoyenne + AssecT_1, family = binomial, data = Protocole_SuiviBlongios)
...
pred_assec$ProfondeurMoyenne <- mean(Protocole_SuiviBlongios$ProfondeurMoyenne, na.rm = TRUE)
pred_assec$julian_day <- mean(Protocole_SuiviBlongios$julian_day, na.rm = TRUE)
