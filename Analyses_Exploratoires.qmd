...
```{r}
#| label: Appel data 1
setwd("C:/Users/LENOVO/Desktop/M2/BIODIV_DATA/oiseaux_bagnas/data/raw")
...
Protocole_SuiviButor<-process_data %>% filter( nom_vernaculaire == "Blongios nain, Butor blongios")
