...
process_data <- read_csv("data/pro/process_data.csv") # charger le jeu de données nettoyé 
```
...
::: justify Cette carte donne la localisation des points d'écoute du protocole Butors et le nombre de Butors contactés (en cliquant sur les points). Les points noirs représentent les sites où aucun Butor n'a été contacté. :::
